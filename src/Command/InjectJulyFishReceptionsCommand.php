    ...
    private function dataset(int $year, string $chambre1, string $chambre2, string $tunnel1, string $tunnel2): array
    {
        ...
        return [
            $this->row([
                ...
                'observations' => 'Reception terrain du 27 soir : Maquereau frais avec glace. Poids BL 5060 kg, poids reel 6776 kg. Stock estime apres retrait glace/dechets : 4857.600 kg (96 % du BL). Episode terrain du 01/07 au 02/07 : 604 kg traites ; le 04/07 sortie 305 kg, produit fini 167 kg, dechets/pertes estimes 138 kg dont 110.400 kg dechets et 27.600 kg pertes/glace/eau. Le reste est conserve en stockage selon les informations fournies.',
            ]),
            $this->row([
                ...
                'observations' => 'Reception terrain du 29 : Maquereau frais. Poids BL 8043 kg, poids reel 8043 kg. Stock estime apres retrait dechets/glace eventuelle : 7721.280 kg (96 % du BL). Stockage estime en Chambre negative 1 faute de chambre precise dans la note.',
            ]),
            $this->row([
                ...
                'observations' => 'Reception terrain du 29 : Anchois 2000 kg BL, 2000 kg reel, recu deja congele et stocke directement en Chambre negative 1. Les etapes intermediaires sont renseignees pour garder un workflow coherent.',
            ]),
            $this->row([
                ...
                'temperatureStockage' => -18,
                'resume' => 'Anchois recu congele, stockage direct.',
                'observations' => 'Reception terrain du 30 : Anchois 3000 kg BL, 3000 kg reel, recu deja congele et stocke directement en Chambre negative 2. Les etapes intermediaires sont renseignees pour garder un workflow coherent.',
            ]),
        ];
    }
